...
<head>
    ...
    <title>Verifica tu correo — Nexa</title>
    <style>
        * {
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td style="text-align:center;padding:0 10px 20px;">
                                        <h1 style="color:#111827;font-size:26px;font-weight:800;margin:0 0 10px;letter-spacing:-0.5px;">Verifica tu correo</h1>
                                        <p style="color:#6B7280;font-size:16px;line-height:1.7;margin:0;text-align:center;">
                                            Usa el siguiente código para verificar tu correo en <strong style="color:#111827;">Nexa</strong>:
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" style="padding:32px 0 24px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="background:#F9FAFB;border-radius:16px;padding:24px 48px;letter-spacing:8px;font-family:'Courier New',monospace;font-size:36px;font-weight:800;color:#111827;">
                                                    {{ $code }}
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom:28px;">
                                        <p style="color:#9CA3AF;font-size:13px;margin:0;">⏳ Este código expirará en <strong style="color:#6B7280;">10 minutos</strong></p>
                                    </td>
                                </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                <p style="margin:0;color:#6B7280;font-size:13px;line-height:1.6;">
                                                                    <strong style="color:#374151;display:block;margin-bottom:2px;">¿No solicitaste este código?</strong>
                                                                    Si no creaste una cuenta en Nexa, ignora este mensaje con tranquilidad.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
