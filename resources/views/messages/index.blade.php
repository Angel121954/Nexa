                ...
                <div class="msg-chat-actions">
                    <div class="msg-chat-dropdown">
                        ...
                        <div class="msg-dropdown-menu" id="msg-dropdown-menu" style="display:none;">
                            ...
                            <div class="msg-dropdown-divider"></div>
                            <button type="button" class="msg-dropdown-item danger" id="msg-delete-btn">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<div class="modal-overlay" id="delete-modal" style="display:none;">
    ...
    <div class="modal-content" style="max-width: 380px;">
        <div class="modal-header">
            <h2>Eliminar conversación</h2>
            <button type="button" class="modal-close-btn" id="delete-modal-close">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path d="M6 18L18 6M6 6l12 12" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </button>
        ...
        <div class="modal-body" style="padding: 1.5rem;">
            <p style="color:var(--text-secondary);font-size:.9375rem;line-height:1.6;margin-bottom:1.5rem;">
                ¿Estás seguro de que quieres eliminar esta conversación?<br>
